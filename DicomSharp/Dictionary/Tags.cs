...
namespace DicomSharp.Dictionary {
    ...
    public class Tags {
        ...
        /// <summary>(0000,0010) VR=UN (DicomCommand) Recognition Code (Retired) 
        /// </summary>
        ...
        /// <summary>(0000,0100) VR=US DicomCommand Field 
        /// </summary>
        ...
        private static readonly Hashtable s_dict = new Hashtable(1853);

        static Tags() {
            FieldInfo[] fields = typeof (Tags).GetFields(BindingFlags.Public | BindingFlags.Static);
            foreach (FieldInfo field in fields) {
                String name = field.Name;
                var tag = (uint) field.GetValue(null);
                s_dict.Add(tag, name);
            }
        }
        ...
        public static void Main() {
            try {
                Console.WriteLine("CommandRecognitionCodeRetired=" +
                                  ToHexString(GetTag("CommandRecognitionCodeRetired")));
                Console.WriteLine("0x00000010=" + GetName(0x00000010));
            }
            catch (Exception e) {
                Console.WriteLine(e);
