...
namespace Dicom.Data {
    ...
    public abstract class DcmObject {
        ...
        public virtual DateTime[] GetDateTimeRange(uint dateTag, uint timeTag) {
            ...
            return new[] {
                             new DateTime((dateRange[0].Ticks - 621355968000000000)/10000 +
                                          (timeRange[0].Ticks - 621355968000000000)/10000*10000 + 621355968000000000),
                             new DateTime((dateRange[1].Ticks - 621355968000000000)/10000 +
                                          (timeRange[1].Ticks - 621355968000000000)/10000*10000 + 621355968000000000)
                         };
        }
        ...
        public virtual DcmElement PutAT(uint tag, int[] values) {
            return Put(values != null ? ValueElement.CreateAT(tag, values) : ValueElement.CreateAT(tag));
        }
        ...
        public virtual DcmElement PutDA(uint tag, DateTime from, DateTime to) {
            return
                Put(from != DateTime.MinValue || to != DateTime.MinValue
        ...
        public virtual DcmElement PutPN(uint tag, String value) {
            return
                Put(value != null
                        ? StringElement.CreatePN(tag, new PersonName(value), GetEncoding())
        ...
        public virtual DcmElement PutPN(uint tag, String[] values) {
            ...
            var a = new PersonName[values.Length];
        ...
        public virtual DcmElement PutSL(uint tag, String value) {
            return
                Put(value != null
                        ? ValueElement.CreateSL(tag, StringUtils.ParseInt(value, Int32.MinValue, Int32.MaxValue))
        ...
        public virtual DcmElement PutSS(uint tag, String value) {
            return
                Put(value != null
                        ? ValueElement.CreateSS(tag, StringUtils.ParseInt(value, Int16.MinValue, Int16.MaxValue))
        ...
        public virtual DcmElement PutSS(uint tag, String[] values) {
            return
                Put(values != null
                        ? ValueElement.CreateSS(tag, StringUtils.ParseInts(values, Int16.MinValue, Int16.MaxValue))
                        : ValueElement.CreateSS(tag));
        }
            ...
            return
                Put(value != null
                        ? ValueElement.CreateUL(tag,
                                                StringUtils.ParseInt(value, 0L, (int) (- (0x100000000 - 0xFFFFFFFFL))))
                        : ValueElement.CreateUL(tag));
        }
        ...
        public virtual DcmElement PutUL(uint tag, String[] values) {
            return
                Put(values != null
                        ? ValueElement.CreateUL(tag,
                                                StringUtils.ParseInts(values, 0L, (int) (- (0x100000000 - 0xFFFFFFFFL))))
                        : ValueElement.CreateUL(tag));
        }
        ...
        public virtual DcmElement PutUS(uint tag, String value) {
            return
                Put(value != null
                        ? ValueElement.CreateUS(tag, StringUtils.ParseInt(value, 0L, 0xFFFFL))
        ...
        public virtual DcmElement PutUS(uint tag, String[] values) {
            return
                Put(values != null
                        ? ValueElement.CreateUS(tag, StringUtils.ParseInts(values, 0L, 0xFFFFL))
                        : ValueElement.CreateUS(tag));
        }
