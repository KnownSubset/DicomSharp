...
namespace Dicom.Utility {
    ...
    public class StringUtils {
        ...
        public static float[] ParseFloats(String[] values) {
            var retval = new float[values.Length];
        ...
        public static Double[] ParseDoubles(String[] values) {
            var retval = new Double[values.Length];
            for (int i = 0; i < retval.Length; ++i) {
        ...
        public static int[] ParseInts(String[] values, long min, long max) {
            var retval = new int[values.Length];
            for (int i = 0; i < retval.Length; ++i) {
        ...
        public static int ParseInt(String value, long min, long max) {
            ...
            if (retval < min || retval > max) {
                throw new FormatException("value: " + value + ", min:" + min + ", max:" + max);
            }
            return (int) retval;
        }
        ...
        public static String PromptBytes(byte[] data, int start, int length, int maxlen) {
            ...
            StringBuilder sb = PromptBytes(new StringBuilder(Math.Min(maxlen, length*3 - 1)), data, start, length,
                                           maxlen);
